  ...
  return (
    <div className="header mb-14">
      ...
      <div className="w-full flex flex-col lg:flex-row items-start justify-between lg:items-center">
        <span className="dark:text-gray-400 text-gray-500 text-sm mb-3">{dictionaries.title}</span>
        <span className="dark:text-gray-400 text-gray-500 text-sm mb-3">{dictionaries.update}</span>
      </div>
